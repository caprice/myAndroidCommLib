...
import com.lite.commons.utils.ServiceUtils;
/**
...
public class NetStateUtil {
	...
	public static boolean checkNet(Context context) {
		...
		ConnectivityManager manager = ServiceUtils.getConnectivityManager(context);
    ...
    public static boolean isWifiEnabled(Context context) {
        ConnectivityManager mgrConn = ServiceUtils.getConnectivityManager(context);
